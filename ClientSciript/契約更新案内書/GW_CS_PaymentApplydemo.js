...
function btnSearchButton() {
	...
	var theLink = nlapiResolveURL('SUITELET', 'customscript_gw_ss_payment_apply_demo', 'customdeploy_gw_ss_payment_apply_demo');
...
function btnPrintButton() {
	...
	var theLink = nlapiResolveURL('SUITELET', 'customscript_gw_contract_update_print_al', 'customdeploy_gw_contract_update_print_al');
