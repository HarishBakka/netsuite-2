...
function main(request, response)
{
    ...
    billingSubList.setLineItemValue("sub_list_billing_date",       1, "2016年5月10日");
    ...
    billingSubList.setLineItemValue("sub_list_billing_date",       2, "2016年5月10日");
    ...
    billingSubList.setLineItemValue("sub_list_billing_date",       3, "2016年5月10日");
